<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="flex flex-col mt-10 text-center">
        <a href="{{ route('portal.dashboard') }}"
            class="font-Poppins py-3 text-sm flex items-center space-x-3 {{ request()->is('portal/admin/dashboard') ? 'bg-red-600 text-white' : 'text-red-600' }}" wire:navigate>
        ...
        <a href="{{ route('portal.attendances') }}"
            class="font-Poppins py-3 text-sm flex items-center space-x-3 {{ request()->is('portal/admin/attendances') ? 'bg-red-600 text-white' : 'text-red-600' }}" wire:navigate>
