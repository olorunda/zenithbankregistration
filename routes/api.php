...
Route::any('/verify_qr', function () {
    ...
    $this->details = QrCode::with(['registration', 'attendance'])->when(date('Y-m-d')=='2024-11-21',function($query){  $query->whereNotNull('date_used'); })->where('token', cleaner($code))->first();
