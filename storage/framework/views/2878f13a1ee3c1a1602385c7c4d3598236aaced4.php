<?php $__env->startSection('title', 'Zenith Trade Seminar::Registration'); ?>
    ...
    <div class="bg-[#111010] bg-opacity-50 backdrop-filter backdrop-blur-md rounded-lg">
        <div class="px-4 py-8 lg:px-4 lg:py-16 mb-4 lg:mb-12">
            <div class="px-4 lg:px-16 w-full h-[150px] lg:h-[200px]">
                <img src="<?php echo e(asset('assets/images/logo_white.png')); ?>" alt=""
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="text-red-600 font-semibold text-xs"><?php echo e($message); ?></p>
                                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="w-full">
                                <div class="relative h-14">
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal4209ccdd55c60cbd168ef152790c641819fc5d9f = $component; } ?>
<?php $component = Victorybiz\LaravelTelInput\LaravelTelInput::resolve(['id' => 'phone','name' => 'phone'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('tel-input'); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:ignore' => true,'wire:key' => ''.e(mt_rand(11111,55555)).'','wire:model.defer' => 'phone','class' => 'block px-3 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg form-class border-white h-14 focus:outline-none focus:ring-0 focus:border-white','placeholder' => '']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal4209ccdd55c60cbd168ef152790c641819fc5d9f)): ?>
<?php $component = $__componentOriginal4209ccdd55c60cbd168ef152790c641819fc5d9f; ?>
<?php unset($__componentOriginal4209ccdd55c60cbd168ef152790c641819fc5d9f); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="w-full">
                            ...
                            <?php $__errorArgs = ['zenith_customer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="w-full">
                            ...
                            <?php $__errorArgs = ['reason_for_attending'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="w-full">
                            ...
                            <?php $__errorArgs = ['attending_masterclass'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="w-full"  style="<?php echo e($show_masterclasses); ?>">
                                <div class="relative h-14">
                            ...
                            <?php $__errorArgs = ['master_classes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center mb-0">
                            ...
                            <?php if($error_message): ?>
                                <p class="text-red-600 font-semibold  text-lg"><?php echo e($error_message); ?></p>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="">
                    <div class="grid grid-cols-1 place-items-center w-full my-auto px-4 lg:px-16 py-4">
                        <div class="bg-white border border-gray-100 shadow-lg py-2 rounded-2xl mb-8">
                            ...
                            <div class="text-center mb-4">
                                <img src="<?php echo e($qr_code_url); ?>" alt="" srcset="" class="mx-auto w-1/4">
                            </div>
                            <div class="text-center mb-4">
                                <p>
                              <strong> Access Code:</strong> <?php echo e($this->token_show); ?>

                                </p>
                            </div>
                            <div class="text-center px-6 lg:px-8">
                                <p class="text-[#4F596A] font-medium mb-2 text-sm">Hey
                                    <strong><?php echo e($lastname); ?></strong>,
                                    thank
...
<?php /**PATH C:\Users\ADMIN\PhpstormProjects\zenithbank\resources\views/livewire/users/index.blade.php ENDPATH**/ ?>