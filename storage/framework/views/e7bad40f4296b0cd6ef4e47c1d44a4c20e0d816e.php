...
<p style='text-align:center; font-weight:bold'>Thank you,  <?php echo e($data->fullname); ?></p>
...
<p><b>Access Code: </b><?php echo e($data->token_code); ?>.</p>
<p><b>Date: </b>Thursday, November 21, 2024.</p>
<p><b>Time: </b>8:00 am</p>
<div style='text-align:center'><img src='<?php echo e(url('qrcode/'.$data->token_code)); ?>' alt='<?php echo e($data->token_code); ?>.jpg' style='width:50%' /></div>
<br>
