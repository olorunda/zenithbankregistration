<header class="flex justify-between items-center px-6 py-4 shadow-lg border-b border-b-main">
    ...
    <div class="flex items-center space-x-4">
        <button class="flex focus:outline-none" aria-label="Color Mode">
            <a href="<?php echo e(route('portal.logout')); ?>" class="border-2 border-main block p-2 shadow-lg rounded-md">
...
<?php /**PATH C:\Users\ADMIN\PhpstormProjects\zenithbank\resources\views/partials/navbar.blade.php ENDPATH**/ ?>